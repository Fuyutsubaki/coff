...
3. From the user's request, fill in the parts of the template you can (title / background & purpose / change plan, etc.). Write the body following the japanese-tech-writing skill. Leave undetermined items blank or as placeholders (the deep-dive is polish's job).
...
<!--{"src":".coff/src/coff-issue-create.skill.md","md5":"43bb05083f44615dd8cb9746b4c101f9"} -->
