...
1. Read `.claude/skills/coff-detail-issue/SKILL.md` to get the location, naming, template, and quality bar.
...
<!--{"src":".coff/src/coff-issue-create.skill.md","md5":"8e740887cd9fb0007ec1c16afdd7a446"} -->
