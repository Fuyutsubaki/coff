...
10. Cleanup. Check the whole written-out issue against detail's rules, fix it, and overwrite. Cover what this session wrote, not only inherited content. Check:
   - Title and 要約: do they narrate history? Do they presuppose an implementation that is not on master?
   ...
   - Rejection reasons and 実装メモ: do vocabulary or premises from an earlier implementation or an earlier polish remain? Is there anything useless, or quick to go stale, for a later reader?
