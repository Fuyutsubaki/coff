...
5. (If needed) trial implementation. Try small experiments to confirm feasibility where it's uncertain. Safety steps:
...
<!--{"src":".coff/src/coff-issue-polish.skill.md","md5":"8b10e2f16988da60691b62fc3ced1eb5"} -->
