...
## Issues
- The entry point for issue management is the coff-issue-create skill. The flow is create → polish → implement → done. List with the coff-issue-list skill.
...
<!--{"src":".coff/src/care-giver.outputstyle.md","md5":"9a2cc27a70bf3b9533521fc7b4cecf79"} -->
