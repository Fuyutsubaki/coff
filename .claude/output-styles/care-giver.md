...
- Don't hand-edit the artifacts under `.claude/` (skills / output-styles / agents). To change an artifact, edit the source under `.coff/src/` and build it with the `/compile` skill (a wrapper around coff-compile that also syncs the distribution mirror).
...
<!--{"src":".coff/src/care-giver.outputstyle.md","md5":"e2b7f5c6a0c39922083b6097a87e79d2"} -->
